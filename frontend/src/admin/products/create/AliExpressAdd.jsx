...
import { fetchAliProduct } from "../../../features/product/productSlice";
      ...
      <div className="w-full bg-white p-8 rounded-2xl">
        ...
        <div className="flex items-center bg-gray-100 p-4 mb-5">
          ...
          >
            ...
            {/* {selectedProduct.skus.length !== 0 && !error && !loading && (
            <button
              type="button"
              className="w-full bg-blue-600 text-white font-semibold py-2 rounded-lg hover:bg-blue-700 transition duration-200"
          ...
          <div className="flex-1">
            <div className="p-4 shadow ml-4">
              ...
              <p className="text-lg font-semibold">
                {selectedProduct.ae_item_sku_info_dtos?.length}
              </p>
              <button
        ...
        {selectedProduct.ae_multimedia_info_dto && (
          <>
            <ProductImages
              images={selectedProduct.ae_multimedia_info_dto?.image_urls}
            />
            <ProductInformationCreate
              productInfo={selectedProduct.ae_item_base_info_dto}
            />
            <AddProperty propertyList={selectedProduct.ae_item_properties.ae_item_property} />
            <AddSKU skuList={selectedProduct.ae_item_sku_info_dtos.ae_item_sku_info_d_t_o} />
          </>
        )}
