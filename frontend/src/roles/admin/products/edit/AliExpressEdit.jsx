...
import AeItemSkuInfoDtos from "./AeItemSkuInfoDtos";
import AeItemEditor from "./AeItemEditor";
...
const AliExpressViewer = () => {
  ...
  return (
    <div className="bg-gradient-to-br border-gray-200 min-h-screen"> 
